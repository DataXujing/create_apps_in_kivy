...
<div align=center>
<img src="../img/ch9/p2.jpg" width=300 /> 
</div>
...
智能车道线项目的安卓打包与上一节中介绍的完全一致，这里仅把`buildozer.spec`文件的内容做详细的介绍,其在安卓手机上的运行可以参考第4章或我们的在线课程演示
...
生成对抗网络(GAN)的一键现实转换二次元动画场景迁移项目的安卓打包与上一节中介绍的完全一致，这里仅把`buildozer.spec`文件的内容做详细的介绍,其在安卓手机上的运行可以参考第5章或我们的在线课程演示
